...
.large {
	...
	background:
		url('${pageContext.request.contextPath}/resources/assets/images/lfc_tee1-1.png')
		no-repeat;
			...
			<div class="row">
					...
					<div class="thumbnail">
						...
						<ul class="products-thumbs">
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_tee1-1.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_tee1-1.png'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_tee1-2.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_tee1-2.png'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_tee1-3.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_tee1-3.png'">
							</li>
						</ul>
						<div class="caption" style="clear: both">
							<h3>LFC BOYS ACADEMY BADGE TEE</h3>
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					...
					<div class="list-group">
						<a href="cart.html" class="list-group-item active"
							style="background-color: #00A398">Add To Cart</a> <a
							href="clothing.html" class="list-group-item">Review Order</a> <a
							href="clothing.html" class="list-group-item">Cancel Order</a>
					</div>
					<a
