...
.large {
	...
	background:
		url('${pageContext.request.contextPath}/resources/assets/images/lfc_studs.png')
		no-repeat;
					...
					<div class="thumbnail">
						...
						<ul class="products-thumbs">
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_studs.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_studs.png'">
							</li>
						</ul>
						<div class="caption" style="clear: both">
							<h3>NEW BALANCE VISARO CONTROL KIDS FG FOOTBALL BOOTS - FIRM
								GROUND</h3>
							<p>
								A stylish galaxy (navy) look given a cherry topping, the Visaro
								Control continues to offer a great fit and comfort for children
								that's been modeled on the Visaro Pro. <br>Although the
								mesh design of the high-end counterpart isn't present, you're
								still left with a soft PU synthetic textured upper that includes
								off-centre lacing for a cleaner and larger strike area.
							</p>
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					...
					<div class="list-group">
						<a
							...
							class="list-group-item" style="background-color: #00A398">Add
