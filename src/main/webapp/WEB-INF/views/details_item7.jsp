...
.large {
	...
	background:
		url('${pageContext.request.contextPath}/resources/assets/images/lfc_football.png')
		no-repeat;
					...
					<div class="thumbnail">
						...
						<ul class="products-thumbs">
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_football.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_football.png'">
							</li>
						</ul>
						<div class="caption" style="clear: both">
							<h3>LFC SIZE 4 PVC FOOTBALL</h3>
