	...
	<div id="main">
		...
		<div id="div2">
			...
			<div
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<p>Just 48 hours after their stunning opening-day win at
										...
										afternoon being put through their paces by JÃ¼rgen Klopp and
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<img
										src="${pageContext.request.contextPath}/resources/Bootstrap/Images/news8.png"
										width="570px" height="350px"> <br> <br>
									<p>Anfield played host to Liverpool FC Foundationâ€™s U16
				...
				<div class="img2">
					...
					<div class="des2">
						Want to grab yourself a hoodie like JÃ¼rgen<br>
					</div>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<img
										src="${pageContext.request.contextPath}/resources/Bootstrap/Images/news9.png"
										width="570px" height="350px"> <br> <br>
									<p>JÃ¼rgen Klopp and the Liverpool squad sported stylish
										brand new hoodies from New Balanceâ€™s 2016-17 range at
										Arsenal on Sunday â€“ and you can grab yours now in our online
										store.</p>
								</div>
							</div>
						</div>
		...
		<div id="container">
			...
			<div style="background-color: #fffff6; height: 400px; width: 1180px;">
				...
				<div style="margin-left: 33px;" class="img1">
					...
					<div class="des1">
						Donâ€™t miss a kick of Kloppâ€™s first pre-season with LFCTV and
		...
		<footer style="margin-left: 0px; margin-right: 0px;" class="footer-distributed">
			...
			<div class="footer-left">
				...
				<p class="footer-company-name">Â© Copyright 2016 The Liverpool
