...
.large {
	...
	background:
		url('${pageContext.request.contextPath}/resources/assets/images/lfc_mug.jpg')
		no-repeat;
					...
					<div class="thumbnail">
						...
						<div class="magnify">
							...
							<img id="mainImg" class="small"
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_mug.jpg"
						...
						<ul class="products-thumbs">
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_mug.jpg"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_mug.jpg'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_mug2.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_mug2.png'">
							</li>
						</ul>
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					...
					<div class="list-group">
						<a
							...
							To Cart</a> <a
							href="${pageContext.request.contextPath}/resources/assets/html/clothing.html"
							class="list-group-item">Review Order</a> <a
							href="${pageContext.request.contextPath}/resources/assets/html/clothing.html"
							class="list-group-item">Cancel Order</a>
					</div>
					<a
