...
.large {
	...
	background:
		url('${pageContext.request.contextPath}/resources/assets/images/lfc_kit.jpg')
		no-repeat;
					...
					<div class="thumbnail">
						...
						<ul class="products-thumbs">
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_kit.jpg"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_kit.jpg'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_kit2.jpg"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_kit2.jpg'">
							</li>
						</ul>
