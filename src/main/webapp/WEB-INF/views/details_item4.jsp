...
.large {
	...
	background:
		url('${pageContext.request.contextPath}/resources/assets/images/lfc_clothing.png')
		no-repeat;
		...
		<div class="container">
			<div class="row">
					...
					<div class="thumbnail">
						...
						<ul class="products-thumbs">
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_clothing.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_clothing.png'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_clothing2.jpg"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_clothing2.jpg'">
							</li>
						</ul>
						<div class="caption" style="clear: both">
							<h3>Liverpool Jersey</h3>
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					...
					<a
						href="${pageContext.request.contextPath}/resources/assetshtml/checkout.html"
