...
.large {
	...
	background:
		url('${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-1.png')
		no-repeat;
...
<body>
					...
					<div class="thumbnail">
						...
						<ul class="products-thumbs">
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-1.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-1.png'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-2.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-2.png'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-3.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-3.png'">
							</li>
							<li><img
								src="${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-4.png"
								height="50%" width="50%"
								onclick="document.getElementById('mainImg').src='${pageContext.request.contextPath}/resources/assets/images/lfc_tee2-4.png'">
							</li>
						</ul>
						<div class="caption" style="clear: both">
							<h3>LFC MENS LONG SLEEVE POLO SHIRT</h3>
							<p>
								This bright LFC Mens Long Sleeve Brechin Polo is from our
								Academy range.<br> A long sleeve navy polo with a white
								contrasting collar and three red button fastening.<br>
								Across the chest is a white block with red embroidered Anfield
								Academy with LFC Liverbird.<br> Verticfal red and yellow
								stripes can be seen down the left hand side with a navy number 8
								to the right sleeve.
							</p>
							<h3>Sizing:</h3>

							<select class="selectpicker" data-size="5">
								<option data-subtext="small">Chest 89-94CM, Waist
									76-81CM</option>
								<option data-subtext="medium">Chest 97-102CM, Waist
									81-86CM</option>
								<option data-subtext="large">Chest 104-109CM, Waist
									86-91CM</option>
							</select>
						...
						<div class="row">
							<div class="col-md-12">
								<span class="glyphicon glyphicon-star"></span> <span
									...
									class="pull-right">1 week ago</span>
								<p>span span span</p>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript"
		src="https://cdn.jsdelivr.net/bootstrap.select/2.0.0-beta1/js/bootstrap-select.min.js"></script>
